...
assert len(parking_lot.available_parking_slots) == 1
assert parking_lot.park (Car("KA-01-P-333", "White")) == 4

assert parking_lot.registration_numbers_cars_with_color("White") == ["KA-01-HH-1234", "KA-01-HH-9999", "KA-01-P-333"]

assert parking_lot.slot_numbers_cars_with_color("White") == [1, 2, 4]
